...
if __name__ == "__main__":
    ...
    while vs.isOpened():
        ...
        if ret: #if successfully able to read next frame
            ...
            new_frame = cv2.resize(new_frame,(width,height)) #resize all frames to Dell Inspiron 15 screen size for accurate input
    ...
    out = cv2.VideoWriter(saved_videoname,cv2.VideoWriter_fourcc('M','J','P','G'), 20, (width,height))
